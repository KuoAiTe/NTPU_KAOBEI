...
//加載界面狀態
typedef enum {
    PullStateNormal = 0,            //正常狀態
    PullStateUpPulling = 1,         //上拉狀態
    PullStateUpHitTheEnd = 2,       //上拉越界狀態
    PullStateDownPulling = 3,       //下拉狀態
    PullStateDownHitTheEnd = 4,     //下拉越界狀態
    PullStateLoading = 5,           //加載狀態
} PullState;
...
- (void)setState:(PullState)pullstate {
    ...
    switch (state) {
        ...
        case PullStateUpPulling:
            ...
            _stateLabel.text = @"上拉螢幕以讀取";
            break;
        case PullStateDownHitTheEnd:
            _arrowView.transform = CGAffineTransformMakeRotation(M_PI);
            _stateLabel.text = @"放開螢幕以更新...";
            break;
